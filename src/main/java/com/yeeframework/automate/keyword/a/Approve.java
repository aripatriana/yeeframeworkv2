...
public class Approve implements ActionType {

	@Override
	public String script() {
		return com.yeeframework.automate.keyword.ActionTypes.APPROVE;
	}

	@Override
	public void run(Object handler, WorkflowEntry we, Workflow workflow) throws Exception {
		ReflectionUtils.invokeMethod(handler, com.yeeframework.automate.keyword.ActionTypes.APPROVE, new Class[] {Workflow.class, ModalType.class}, new Object[] {workflow, ModalType.MAIN});
	}
